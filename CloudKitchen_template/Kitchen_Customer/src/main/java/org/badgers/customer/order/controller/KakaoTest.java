...
public class KakaoTest {
	...
	private static void paymentReady() {
	    ...
	    params.add("approval_url", "http://13.124.176.77/customer/main");
	    params.add("cancel_url", "http://13.124.176.77/customer/main");
	    params.add("fail_url", "http://13.124.176.77/customer/main");
