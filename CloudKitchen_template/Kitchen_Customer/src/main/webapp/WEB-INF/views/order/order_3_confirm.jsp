	...
	<div class="row">
		<div class="col-md-offset-3 col-md-6">
			<div class="box_style_2">
                ...
                <a href="${pageContext.request.contextPath}/member/${uid}/mypage/orderinfo" class="btn btn-success" style="display:block; text-align: center; margin-bottom:5px;">나의 주문내역으로 가기</a>
                <a href="${pageContext.request.contextPath}/main" class="btn btn-warning" style="display:block; text-align: center;">메인으로 돌아가기</a>
			</div>
		</div>
	</div><!-- End row -->
</div><!-- End container -->
