...
public class httpUrlConnectionTest {
	...
	public static void main(String[] args) throws Exception {
		httpUrlConnectionTest fcmTest = new httpUrlConnectionTest();
		fcmTest.index();
	}
	...
	public String index(){
			...
			URL url;
            String fcmToken = "fTsvD08oRvU:APA91bFN5Iu4awzj8EFFtpoCOjIsOBRp8tSwpiwv9BRclibMrY4fqSU_zi1lxFj_FadvSwO1zeer41xMwMBCd_TqYzUhiehrbdCA-tUTZ7_mlG3_yn_Yh6qBRZDQgyMPRFvSokND9EHI";
            String id ="1234";
			try {
				url = new URL("http://localhost/rest/cust/fcm");
	            ...
	            conn.setDoOutput(true);
	            String input = "{\"id\" :\""+id+"\" , \"fcmToken\":\""+fcmToken+"\"}";
